...
function AdminTransactionDetail() {
  ...
  return (
    <div className="w-full p-4 sm:p-6 print-container" id="invoice-pdf-admin">
      <style>
        {`
          @media print {
            ...
            .print-invoice-header { display: block !important; text-align: center; margin-bottom: 20px; }
            .print-invoice-header h1 { font-size: 24px; color: black; }
            .print-invoice-header p { font-size: 12px; color: gray; }
            .print-table td, .print-table th { color: black !important; }
          }
        `}
      </style>
      ...
      <div className="flex flex-col sm:flex-row justify-between items-center mb-6 no-print">
        <Link
          ...
          className="inline-flex items-center text-blue-600 hover:text-blue-700 group text-sm mb-3 sm:mb-0"
        >
          ...
          {transaction.cashier && (
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="font-medium text-gray-700 text-base">{transaction.cashier?.name || 'N/A'}</p>
                {transaction.cashier?.email && <p className="text-xs text-gray-500">{transaction.cashier.email}</p>}
              </div>
            </div>
          )}
